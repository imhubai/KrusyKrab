    ...
    <div class="mt-10 sm:w-full sm:max-w-xs max-w-full w-screen px-4 bg-stone-50 rounded-sm bg-opacity-75 shadow-xl backdrop-blur-sm">
        ...
        <form class="space-y-2 mt-2" action="#" method="POST">
            <div>
                ...
                <div class="mt-2">
                    <input id="account" name="username" type="text" autocomplete="account" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-semibold text-blue-500 hover:text-blue-600" onclick="alert('这你都能忘?')">忘记密码?</a>
                    </div>
                </div>
                <div class="mt-2">
                    <input id="password" name="userpassword" type="password" autocomplete="current-password" required
        ...
        <p class="mt-20 text-center text-sm text-gray-700">还没有账号?<a href="register" class="font-semibold leading-6 text-blue-500 hover:text-blue-600">立即注册，享受X折优惠!</a>
        </p>
    </div>
</div>