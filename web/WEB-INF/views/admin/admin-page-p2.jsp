...
<main id="maincontent" class="h-full pb-16 overflow-y-auto">
                        ...
                        <tr id="trlist-${admin.aid}" class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-1">
                                <div class="flex items-center space-x-4 text-sm">
                                    <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leadng-5 text-purple-60i0 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
    ...
    <%@include file="./editcards/admin-page-p2-editcard.jsp" %>
    <script>
        /*
