        ...
        <div class="relative block">
            <div class="box-border block w-full h-full text-gray-600">
                <div class="box-border block w-full h-full p-2">
                    <div class="box-border block pb-20">
                        <div class="box-border block bg-white">
                            <div class="box-border relative block shadow-md overflow-y-auto">
                                <!-- 地址位置开始 -->
                                <div class="box-border relative flex items-center w-full overflow-hidden border-b-2 border-b-black">
                                    <div class="box-border relative flex items-center w-full pt-2 pb-2 pl-2 pr-2 overflow-hidden text-base text-gray-500 bg-white">
                                        <div class="box-border flex items-center w-full">
                                            <div class="box-border flex flex-col w-3/5">
                                                <div class="block w-full mb-2 overflow-hidden text-base text-gray-900 font-bold text-ellipsis whitespace-nowrap">
                                                    ${shopName}
                                                </div>
                                                <div class="flex flex-row justify-start items-center w-full overflow-hidden">
                                                    <div class="relative flex-shrink-0 inline-block overflow-hidden size-7">
                                                        <svg t="1721011348610" class="icon" viewBox="0 0 1024 1024"
                                                             version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                             p-id="5172" width="20" height="20">
                                                    ...
                                                    <div class="box-border block overflow-hidden text-sm text-gray-800 text-ellipsis whitespace-nowrap">
                                                        ${shopAddress}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex items-center justify-end w-2/5">
                                                <div class="flex items-center justify-center relative inline-block overflow-hidden size-14">
                                                    <svg t="1721011582708" class="" viewBox="0 0 1024 1024"
                                                         version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6719"
                                                         width="22" height="22">
                                                        <path d="M123.92 555.9a32 32 0 0 1-14.82-60.38l719.19-374.9a32 32 0 0 1 29.59 56.76l-719.2 374.89a31.87 31.87 0 0 1-14.76 3.63z"
                                                              fill="#333333" p-id="6720"></path>
                                                        <path d="M608.6 957.7a32 32 0 0 1-30.6-41.27l234.64-776.34a32 32 0 0 1 61.26 18.52L639.22 935a32 32 0 0 1-30.62 22.7zM505.92 580.44c-0.68 0-1.36 0-2.05-0.07l-381.46-24.12a32 32 0 1 1 4-63.88l381.5 24.13a32 32 0 0 1-2 63.94z"
                                                              fill="#333333" p-id="6721"></path>
                                                        <path d="M608.14 957.32a32 32 0 0 1-30.87-23.63L475 556.82a32 32 0 1 1 61.77-16.76L639 916.93a32 32 0 0 1-22.51 39.26 31.61 31.61 0 0 1-8.35 1.13z"
                                ...
                                <!-- 地址位置结束 -->
                                <div class="box-border relative flex items-center w-full pt-3 pb-3 overflow-y-auto overflow-x-hidden text-base text-gray-500 bg-white border-b-2 border-black pl-1 pr-1">
                                        ...
                                        <c:forEach items="${cartList}" var="v">
                                            <div class="box-border flex items-center w-full mb-1">
                                                <div class="box-border flex flex-col w-3/5 overflow-hidden">
                                                    <div class="box-border block mb-1 overflow-hidden text-sm text-gray-900 font-bold text-ellipsis whitespace-nowrap">
                                                            ${v.productName}
                                                    </div>
                            ...
                            <div class="box-border relative flex items-center w-full pt-3 pb-3 overflow-hidden text-base text-gray-700 bg-white pr-1 pl-1">
                                <div class="box-border flex flex-col w-full">
                                    <div class="box-border flex items-center justify-between w-full text-sn text-gray-700 mb-1">
                                        <div class="box-border block">取餐方式</div>
                                        <div class="box-border block font-bold">${action}</div>
                                    </div>
                                    <div class="box-border flex items-center justify-between w-full text-sm text-gray-700 mb-1">
                                        <div class="box-border block">取餐时间</div>
                                        <div class="box-border block font-bold">立即取餐</div>
                                    </div>
                                    <div
                                            class="box-border flex items-center justify-between w-full mb-1 text-sm text-gray-700">
                                        <div class="box-border block">备注</div>
                                        <div class="box-border block font-bold">打包</div>
                                    </div>
                                </div>
                            </div>
                            <div class="justify-end items-center flex w-full text-base">
                                <span class="font-bold mr-1">
                                    共 ${price} 元
                                </span>
                                <button id="order-pay" onclick="order_pay()" class="mr-1 flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-lime-600 border border-transparent rounded-lg active:bg-lime-600 hover:bg-lime-700 focus:outline-none focus:shadow-outline-lime">
                                    <span>去支付</span>
